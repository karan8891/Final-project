<%@ Page Title="" Language="C#" MasterPageFile="~/my_master.Master" AutoEventWireup="true" CodeBehind="add_product.aspx.cs" Inherits="mobile.add_product" %>
			...
			<div class="contact agileits">
				<div class="contact-agileinfo">
					<div class="contact-form wthree">
                        ...
                        ConnectionString="<%$ ConnectionStrings:sqlconnection %>" SelectCommand="SELECT * FROM [sub_category] WHERE ([category_id] = @category)">
                        <SelectParameters>
                        ...
                        ErrorMessage="Product Name Must Be Filled" ControlToValidate="brand" ForeColor="#CC0000"></asp:RequiredFieldValidator>
			            ...
			            <asp:RequiredFieldValidator ID="RequiredFieldValidator10" runat="server" ErrorMessage="Choose Image" ForeColor="#CC0000" ControlToValidate="PhotoUploadControl2"></asp:RequiredFieldValidator>
                        <asp:FileUpload ID="PhotoUploadControl3" runat="server" />
			            <asp:RequiredFieldValidator ID="RequiredFieldValidator11" runat="server" ErrorMessage="Choose Image" ForeColor="#CC0000" ControlToValidate="PhotoUploadControl3"></asp:RequiredFieldValidator>
					    ...
					    <br />
                        <asp:Button ID="add" runat="server" Text="Add Product Details" onclick="add_Click" />
					</div>
