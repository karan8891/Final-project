...
namespace mobile
{
    public partial class user_login : System.Web.UI.Page
    {
        ...
        protected void signin_Click(object sender, EventArgs e)
        {
            ...
            obj.Open();
            SqlCommand objselect = new SqlCommand("select count(*) from user_signup where email_id='" + email_id.Text + "' and password='" + pass.Text + "'", obj);
            int a = Convert.ToInt32(objselect.ExecuteScalar().ToString());
            if (a > 0)
            {

                Session["user_login"] = email_id.Text;
